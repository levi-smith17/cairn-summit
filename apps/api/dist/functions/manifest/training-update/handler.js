...
const handler = async (event) => {
    try {
        ...
        if (!id) {
            return (0, response_1.toApiGatewayResponse)((0, response_1.badRequest)('Missing training id'));
        }
        ...
        const exprValues = {};
        const fields = [
            { key: 'institution', alias: '#institution' },
            { key: 'degree', alias: '#degree' },
            { key: 'field', alias: '#field' },
