...
import { updateStonePlacement, resetGuidePlacements } from '@/lib/api/guides'
import {
  ArrowLeft,
  ChevronLeft,
  ChevronRight,
...
export function GuidePassClient({ title, stones: initialStones, allMarkers, backUrl, guideIds }: GuidePassClientProps) {
  ...
  function handleSetPlacement(placement: StonePlacement) {
    ...
    updateStonePlacement(stoneId, placement).catch(console.error)
  }
              ...
              {!hasStones ? (
                ...
                <div className="flex flex-col items-center gap-6 w-full max-w-sm text-center">
                  ...
                  <div className="flex flex-col gap-2 w-full">
                    <Button onClick={() => navigate(backUrl)} variant="outline" className="w-full gap-2">
                      <ArrowLeft className="h-3.5 w-3.5" />
