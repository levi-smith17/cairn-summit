...
import { saveWayfarer, deleteWayfarer, startImpersonation } from '@/actions/admin'
import type { WayfarerSummary } from './wayfarer-list'
...
export function WayfarerForm({
  ...
  async function handleDelete() {
    ...
    setDeleting(false)
    if (!result.ok) {
      // toast is handled by action errors; just close dialog
  ...
  function handleViewAs() {
    ...
    startImpersonate(async () => {
      await startImpersonation(wayfarer.id)
