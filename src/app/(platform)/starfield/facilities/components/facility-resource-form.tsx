  ...
  async function handleSave() {
    ...
    try {
      ...
      updatedSystems = updatedSystems.map(s =>
        s.id === finalSystemId ? { ...s, planets: [...s.planets, planet] } : s
      )
        ...
        <Form {...form}>
          <form id="facility-resource-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField control={form.control} name="subfacility1Id" render={({ field }) => (
              <FormItem>
                <PlanetSelect label="Subfacility 1" value={field.value ?? ''} onChange={field.onChange} systems={systems} onSystemsUpdate={setSystems} optional />
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormField control={form.control} name="subfacility2Id" render={({ field }) => (
              <FormItem>
                <PlanetSelect label="Subfacility 2" value={field.value ?? ''} onChange={field.onChange} systems={systems} onSystemsUpdate={setSystems} optional />
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormField control={form.control} name="subfacility3Id" render={({ field }) => (
              <FormItem>
                <PlanetSelect label="Subfacility 3" value={field.value ?? ''} onChange={field.onChange} systems={systems} onSystemsUpdate={setSystems} optional />
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormField control={form.control} name="relayId" render={({ field }) => (
              <FormItem>
                <PlanetSelect label="Relay" value={field.value ?? ''} onChange={field.onChange} systems={systems} onSystemsUpdate={setSystems} optional />
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormActions
              ...
              saved={saved}
              error={error}
              saveLabel={facilityResource ? 'Save Changes' : 'Add Resource'}
